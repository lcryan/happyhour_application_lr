    ...
    return (
        <>
            <div className="about-greeting">
                <h1>
                    About The Happy Hour Team
                </h1>
            </div>

            <section className="container-about-us-texts">
                <article className="our-mission-text">
                    <h2>Our mission</h2>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
                        there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the
                        Semantics, a large language ocean. A small river named Duden flows by their place and
                        supplies it with the necessary regelialia.</p>
                    <p>It is a paradisematic country, in which roasted
                        ...
                        text by the name of Lorem Ipsum decided to</p>
                </article>

                <article className="our-community-text">
                    <h2>Our Community</h2>
                ...
                <article className="our-services-text">
                    <h2>Our Service</h2>
